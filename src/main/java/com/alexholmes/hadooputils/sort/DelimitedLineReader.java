...
/**
 *
 * Note: this is a direct copy of LineReader from Hadoop 2.0,
 * which contains fixes for HADOOP-8655 and HADOOP-4512
 * Mark Cusack 2014/01/17
 * 
 */
...
public class DelimitedLineReader implements Closeable {
   ...
   * @throws IOException
   */
  public DelimitedLineReader(InputStream in) {
   ...
   * @throws IOException
   */
  public DelimitedLineReader(InputStream in, int bufferSize) {
    this.in = in;
   ...
   */
  public DelimitedLineReader(InputStream in, byte[] recordDelimiterBytes) {
    this.in = in;
   ...
   * @throws IOException
   */
  public DelimitedLineReader(InputStream in, Configuration conf,
