...
package com.alexholmes.hadooputils.combine.avro;
 ...
 */
public class AvroFileGenerator extends Configured implements Tool {

    public int run(final String[] args) throws Exception {

        if (args.length != 2) {
            System.err.println(String.format("Usage: %s: <file path> <number of records>", AvroFileGenerator.class.getName()));
            return 1;
        }
    ...
    public static void main(final String[] args) throws Exception {
        int res = ToolRunner.run(new Configuration(), new AvroFileGenerator(), args);
        System.exit(res);
    }
}
